...
User Function JSGLBPAR( lCheck )
    ...
    oDlgConf:SetTitle( 'PlugIn SmartSupply - '+ U_JSGETVER() )
    oDlgConf:SetSubTitle( 'Permite definir os parâmetros e configurações internas do Painel de Compras para ERP Protheus' )
